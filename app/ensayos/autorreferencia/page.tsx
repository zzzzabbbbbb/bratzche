...
const SECTIONS: EssaySection[] = [
  {
    ...
    paragraphs: [
      "Las matemáticas no pesan. No ocupan espacio. No tienen temperatura ni duración ni color. Son entidades sin carne, relaciones puras, estructuras que existen en ningún lugar. Y sin embargo, cuando el universo quiere decirse a sí mismo con precisión, habla en matemáticas. Ahí hay algo que no me termina de cerrar y donde continúa la pregunta.",
      "En un ensayo anterior llegué a una conclusión que me dio serenidad. Si todo es campo, si las partículas son excitaciones, si lo que llamamos materia es vibración organizada del vacío cuántico, entonces el \"yo\" no es sustancia. Es una especie de configuración transitoria. Un patrón que emerge y se disuelve. No hay núcleo metafísico escondido detrás del fenómeno. Solo estructura dinámica. Solo eso bastaba.",
      "Pero quedó una apertura que no terminé de cerrar. ¿Por qué la estructura es capturable/medible matemáticamente? ¿Por qué abstracciones desarrolladas sin contacto con el mundo físico terminan describiendo el mundo físico con precisión absurda?",
      ...
      "Cinco constantes fundamentales en una ecuación. Euler la llamó la más bella de las matemáticas. Conecta el círculo con el crecimiento exponencial, con los números imaginarios, con la unidad y con la nada. No hay razón obvia para que estén relacionadas. Pero lo están.",
      ...
      "Una interpretación: las matemáticas son el catálogo de todas las estructuras coherentes posibles. El universo físico realiza algunas de ellas. Cuando encontramos correspondencia, no imponemos forma arbitraria. Detectamos coincidencia en la base.",
      "La noción de invarianza es clave (esta palabra lo es también). La velocidad de la luz es la misma en todo sistema de referencia. La carga del electrón es la misma en todo lugar del universo. Las leyes de la física son las mismas hoy que hace mil millones de años. Estas constancias no son convenciones. Son señales de que tocamos algo constitutivo.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "La regresión no termina y no es porque nos falte papel. Es porque la operación de clausura genera más sistema. Cada intento de cerrar abre aun más.",
      ...
      "El mapa de Borges no es una simple metáfora, es la estructura misma del plano.",
    ],
  },
  {
    id: "iii",
    ...
    paragraphs: [
      "John Archibald Wheeler fue uno de los físicos más importantes del siglo XX. Trabajó con Bohr y fue mentor de Feynman. Acuñó \"agujero negro\" y \"agujero de gusano\". No era un místico, era un físico riguroso.",
      ...
      "El experimento de elección retardada lo ilustra. Un fotón viaja y antes de que llegue al detector, decides qué tipo de medición harás. Tu decisión presente determina qué \"hizo\" el fotón en el pasado. No es que cambie el pasado. Es que el pasado no estaba definido hasta que tu medición lo fijó.",
